...
storage_1 = Shop(items={"Телефон":10, "Компьютер":20, "Телевизор":20}, capacity=100)
storage_2 = Shop(items={"Телефон":10, "Компьютер":20, "Приставка":20}, capacity=100)
shop_1 = Shop(items={"Телефон":3, "Компьютер":3, "Приставка":3})


# storage_1=Shop(items = {"Телефон":10, "Компьютер":20}, capacity=100)
#
